...
public class EncryptUtil {
    ...
    public static void main(String[] args) {
    	String str=Base64Encode("123");
    	String aes=AESencode("wwww111","2222");
		System.out.println("base64加密:"+str);
		System.out.println("base64解密："+Base64Decode(str));
		System.out.println("=============================");
		System.out.println("ASE:"+AESencode(str,"2222"));
		System.out.println("ASE:"+AESdecode(aes,"2222"));
	}
}
