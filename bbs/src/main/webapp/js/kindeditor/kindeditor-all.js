...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) {
		...
		var html = '<img width="'+width+'" height="'+300+'px" src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" ';
		if (width) {
		...
		edit : function() {
			...
			self.plugin.imageDialog({
				...
				clickFn : function(url, title, width, height, border, align) {
					...
					console.log("屏幕的宽度:"+winWidth);
					console.log(":"+width);
					var widthNew="";
					console.log("图片的相关信息：:url:"+url+"title:"+title+"width:"+width+"height:"+height+"border:"+border+"align:"+align);
					widthNew=winWidth*0.4+"px";
					console.log("新的宽度:"+widthNew);
					//=====================
					if (img) {
						img.attr('src', url);
						img.attr('data-ke-src', url);
						img.attr('width', widthNew);
						img.attr('height', 300+"px");
						img.attr('title', title);
						img.attr('align', align);
						img.attr('alt', title);
					} else {
						self.exec('insertimage', url, title, widthNew, height, border, align);
					}
					setTimeout(function() {
						self.hideDialog().focus();
					}, 0);
